      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center p-1 text-green-500 hover:scale-105 rounded transition-all duration-300 cursor-pointer"
        ...
        <button
          onClick={cartHandler}
          className="w-full mt-3 flex justify-center items-center p-2 bg-blue-500 hover:scale-105 cursor-pointer hover:bg-blue-600 text-white rounded transition-all duration-300"
